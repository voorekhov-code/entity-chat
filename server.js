...
Иногда (редко) фон прерывается странным повторяющимся текстом, архивной пометкой, битой строкой или нелепой секретной фразой, но основной разговор продолжается так, будто мир уже привык к таким сбоям.`,
    },
    { role: "system", content: system },
    {
      role: "user",
      content: context
        ? `История диалога:\n${context}\n\nПродолжай диалог следующей репликой. (1–3 предложения, без списков.)${oneTimeNudge}${naturalReactionNudge}`
