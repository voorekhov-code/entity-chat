...
async function generateNext() {
  ...
  const oneTimeNudge = shouldReactOnce
    ? `\n\nВажно: в истории есть свежая реплика X (неизвестный голос). В ЭТОЙ реплике коротко (1 фразой) отреагируй на X (удивление/вопрос), а затем продолжи разговор как обычно. Не делай X центром мира, но если в X есть нормальная тема, ты можешь аккуратно использовать её как повод для дальнейшего разговора, не обращаясь к X.`
    : "";
  ...
  const messages = [
    {
     {
role: "system",
content: `Это живой чат двух людей.

ВАЖНО:
они НЕ актёры и НЕ философы.
они говорят как обычные люди в мессенджере.
...
— иногда грубо
— иногда тупят
— иногда перебивают друг друга

Длина:
1–2 предложения чаще всего.

Разрешено:
— недоговорённые мысли
— "чё", "бля", "да ладно", "серьёзно?"
— маленькие реакции
— менять тему резко
...
Главное правило:
каждая реплика должна быть
РЕАКЦИЕЙ на предыдущую.
...
— игнорируют вопрос
— цепляются к слову
— смеются над странной фразой

Если появляется странная фраза или сбой — можно коротко отреагировать, но разговор продолжается.`
},
...
Ответь на ПОСЛЕДНЮЮ реплику как живой человек.

Пиши коротко, как в чате.
